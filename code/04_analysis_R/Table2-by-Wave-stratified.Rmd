...
### Hospitalisations without critical care
...
## Subset to hospitalised patients who *don't* receive any critical care
```{r}
cohort %>%
  filter(wave != 1.5,
         hospitalisation == 1,
...
## Critical care OUTSIDE ICU only
```{r}
cohort %>%
  filter(wave != 1.5,
         critical_care == 1,
