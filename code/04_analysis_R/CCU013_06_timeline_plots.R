...
library("ggplot2")
library("stringr")
source("~//CCU013/04_analysis_R-GITHUB-v3/CCU013_colorscheme.R")
...
vax <- dbGetQuery(con, "SELECT distinct person_id_deid, dose2 FROM .ccu013_vaccine_status_paper_cohort")
...
# Export ------------------------------------------------------------------
pdf("~//CCU013/output/figures/CCU013_supl-fig3_timeline_pheno.pdf", height = 9, width = 7)
p3
dev.off()

pdf("~//CCU013/output/figures/CCU013_supl-fig4_timeline_source.pdf", height = 9, width = 7)
p4
dev.off()
