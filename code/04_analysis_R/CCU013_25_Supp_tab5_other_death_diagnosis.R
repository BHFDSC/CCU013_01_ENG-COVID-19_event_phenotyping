...
death_diags <- dbGetQuery(con, "SELECT * FROM .ccu013_tmp_deaths") # From CCU013_01_create_table_alias
...
#-- Save output
out <- rbind(out2, out1)
write.table(out, "~//CCU013/output/tables/CCU013_supp_tab5_most_frequent_death_diagnosis.txt", sep = "\t", quote = F, row.names = F)
