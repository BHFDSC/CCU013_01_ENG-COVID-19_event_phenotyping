...
death_diags <- dbGetQuery(con, "SELECT * FROM dars_nic_391419_j3w9t_collab.ccu013_tmp_deaths") # From CCU013_01_create_table_alias
...
#-- Save output
out <- rbind(out2, out1)
write.table(out, "~/dars_nic_391419_j3w9t_collab/CCU013/output/tables/CCU013_supp_tab5_most_frequent_death_diagnosis.txt", sep = "\t", quote = F, row.names = F)
