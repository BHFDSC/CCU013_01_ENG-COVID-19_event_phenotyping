...
library(scales)
library(dplyr)
source("~//CCU013/04_analysis_R/CCU013_colorscheme.R")
source("~//CCU013/04_analysis_R/CCU013_trejectory_plot_function.R")
# ---- Load data -----------------------------------------------
...
tdata <- dbGetQuery(con, "SELECT * FROM .ccu013_covid_trajectory_graph_data")
nrow(tdata) # 5997870
