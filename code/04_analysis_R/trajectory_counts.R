...
## Wave 1
d <- as.data.frame(fread("~//CCU013/output/trajectories/CCU013_trajectories_ICU_individual_trajectories_wave1.txt"))
head(d)
...
## Wave 1
d <- as.data.frame(fread("~//CCU013/output/trajectories/CCU013_trajectories_ICU_individual_trajectories_wave2.txt"))
