...
traject <- dbGetQuery(con, "SELECT * FROM .ccu013_covid_trajectory_cohort_paper")
...
sum(output[,"percent"])
write.table(output, "~//CCU013/output/CCU013_venn_numbers.txt", sep = "\t", quote = F, row.names = F)
...
pdf("~//CCU013/output/CCU013_venn.pdf")
