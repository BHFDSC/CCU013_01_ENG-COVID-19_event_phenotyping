...
death_diags <- dbGetQuery(con, "SELECT * FROM .ccu013_tmp_deaths")
...
#-- Save output
out <- rbind(out2, out1)
write.table(out, "~//CCU013/output/CCU013_most_frequent_death_diagnosis.txt", sep = "\t", quote = F, row.names = F)
