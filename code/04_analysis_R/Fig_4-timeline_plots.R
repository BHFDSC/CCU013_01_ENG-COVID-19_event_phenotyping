...
trajdata <- dbGetQuery(con, "SELECT DISTINCT person_id_deid, trajectory_phenotype, date FROM .ccu013_covid_trajectory_graph_data")
...
pdf("~//CCU013/output/CCU013_timeline_covid_pheno_density.pdf", height = 9, width = 7)
p1
dev.off()

pdf("~//CCU013/output/CCU013_timeline_covid_pheno_hist.pdf", height = 9, width = 7)
p2
dev.off()

pdf("~//CCU013/output/CCU013_timeline_covid_pheno_density_not_grouped.pdf", height = 9, width = 7)
p3
dev.off()

pdf("~//CCU013/output/CCU013_timeline_covid_source_density_not_grouped.pdf", height = 9, width = 7)
p4
dev.off()

pdf("~//CCU013/output/CCU013_timeline_all_events_trajectory_companion.pdf", height = 4.5, width = 8)
p5
dev.off()
