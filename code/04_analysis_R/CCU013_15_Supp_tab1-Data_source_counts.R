d <- dbGetQuery(con, "SELECT person_id_deid, date, covid_phenotype, source FROM .ccu013_covid_trajectory_paper_cohort")
...
write.table(mytab, "~//CCU013/output/tables/CCU013_supp_tab1_ids_by_source.txt", row.names = F, sep = "\t", quote = F) 
