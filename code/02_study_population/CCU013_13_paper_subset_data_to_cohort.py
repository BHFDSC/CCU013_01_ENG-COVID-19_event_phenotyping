...
# MAGIC SELECT count (*) from .ccu013_covid_trajectory_paper_cohort
...
# MAGIC SELECT s.person_id_deid, s.date, s.covid_severity, s.ProductionDate FROM .ccu013_covid_severity as s
