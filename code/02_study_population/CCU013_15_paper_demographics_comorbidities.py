...
# MAGIC     * `.ccu003_direfcts_dataprep_1_gdppr_frzon28may_mm_210528`: link `person_id_deid` -> `lsoa`
...
# MAGIC 
# MAGIC **Data output**  
# MAGIC * `.ccu013_covid_events_demographics_paper_cohort` 1 row per patient
# MAGIC 
...
# MAGIC %sql
# MAGIC SELECT * FROM .ccu013_covid_events_demographics_paper_cohort
