...
# MAGIC SELECT count(DISTINCT pat.NHS_NUMBER_DEID) FROM dars_nic_391419_j3w9t_collab.ccu013_dp_patient_fields_ranked_pre_cutoff pat 
# MAGIC         LEFT JOIN (SELECT NHS_NUMBER_DEID, ETHNIC FROM dars_nic_391419_j3w9t_collab.ccu013_dp_patient_fields_ranked_pre_cutoff WHERE ethnic_recency_rank = 1) eth ON pat.NHS_NUMBER_DEID = eth.NHS_NUMBER_DEID
# MAGIC         LEFT JOIN (SELECT NHS_NUMBER_DEID, SEX FROM dars_nic_391419_j3w9t_collab.ccu013_dp_patient_fields_ranked_pre_cutoff WHERE sex_recency_rank = 1) sex ON pat.NHS_NUMBER_DEID = sex.NHS_NUMBER_DEID
...
# MAGIC         -- Line below Makes no difference to count if removed
# MAGIC         LEFT JOIN (SELECT NHS_NUMBER_DEID, DATE_OF_DEATH FROM dars_nic_391419_j3w9t_collab.ccu013_dp_patient_fields_ranked_pre_cutoff WHERE death_recency_rank = 1) dod ON pat.NHS_NUMBER_DEID = dod.NHS_NUMBER_DEID
# MAGIC         LEFT JOIN dars_nic_391419_j3w9t_collab.ccu013_dp_patient_dataset_presence_lookup pres ON pat.NHS_NUMBER_DEID = pres.NHS_NUMBER_DEID -- Fails if removed
...
# MAGIC dars_nic_391419_j3w9t_collab.ccu013_dp_patient_dataset_presence_lookup
# MAGIC where gdppr = 1
...
# MAGIC %sql
# MAGIC SELECT * FROM dars_nic_391419_j3w9t_collab.ccu013_dp_patient_dataset_presence_lookup tab1
...
# MAGIC ANTI JOIN dars_nic_391419_j3w9t_collab.ccu013_dp_patient_dataset_presence_lookup tab2 on tab1.person_id_deid = tab2.NHS_NUMBER_DEID
