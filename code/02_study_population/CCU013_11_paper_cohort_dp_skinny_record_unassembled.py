...
# MAGIC  
# MAGIC **Date last run** 2021-06-13
# MAGIC  
...
# MAGIC %run /Workspaces//CCU013/COVID-19-SEVERITY-PHENOTYPING/CCU013_01_helper_functions
...
spark.sql(f"""
 ...
 SELECT DISTINCT PERSON_ID_DEID as NHS_NUMBER_DEID, 
      ...
      0 as primary,
      FYEAR
  FROM .ccu003_direfcts_dataprep_1_apc_all_frzon28may_mm_210528"""
)
...
# MAGIC %sql
# MAGIC SHOW COLUMNS FROM .ccu003_direfcts_dataprep_1_gdppr_frzon28may_mm_210528

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT DISTINCT REPORTING_PERIOD_END_DATE FROM .ccu003_direfcts_dataprep_1_gdppr_frzon28may_mm_210528
# MAGIC -- ONLY 26 rows for this! ? monthly extract batches
...
# MAGIC %md
# MAGIC Chris visualising outputs
