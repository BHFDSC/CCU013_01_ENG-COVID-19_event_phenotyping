...
# MAGIC %run /Workspaces/dars_nic_391419_j3w9t_collab/CCU013/COVID-19-SEVERITY-PHENOTYPING/CCU013_01_helper_functions
...
spark.sql(f"""
 ...
 SELECT DISTINCT PERSON_ID_DEID as NHS_NUMBER_DEID, 
      ...
      0 as primary,
      FYEAR
  FROM dars_nic_391419_j3w9t_collab.ccu003_direfcts_dataprep_1_apc_all_frzon28may_mm_210528"""
)
...
# MAGIC %sql
# MAGIC SHOW COLUMNS FROM dars_nic_391419_j3w9t_collab.ccu003_direfcts_dataprep_1_gdppr_frzon28may_mm_210528

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT DISTINCT REPORTING_PERIOD_END_DATE FROM dars_nic_391419_j3w9t_collab.ccu003_direfcts_dataprep_1_gdppr_frzon28may_mm_210528
