...
# MAGIC **Description** 
# MAGIC 
# MAGIC This notebook runs a list of pyspark operations to produce an events table from the trajectory table for the **paper_cohort**
# MAGIC <br>
# MAGIC   
...
# MAGIC  
# MAGIC **Data input**  
# MAGIC * `.ccu013_covid_trajectory_paper_cohort` Specified in cell 4 below  
# MAGIC 
# MAGIC **Data output**  
# MAGIC * `.ccu013_covid_events_paper_cohort` 1 row per patient, specified in cell 4 below
# MAGIC 
...
# Input tables
trajectory_table = ".ccu013_covid_trajectory_paper_cohort"
# Output table
# NB no dars_.. prefix
output_table = "ccu013_covid_events_paper_cohort"
...
# NB only call within this cell so it can't be overwritten first from other notebook
...
# MAGIC SELECT COUNT(distinct person_id_deid) FROM .ccu013_covid_events_paper_cohort
...
# MAGIC %sql
# MAGIC SELECT * FROM .ccu013_covid_events_paper_cohort WHERE date_first > '2021-11-02' AND death != 1
