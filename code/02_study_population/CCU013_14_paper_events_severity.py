...
# MAGIC 
# MAGIC **Data output**  
# MAGIC * `dars_nic_391419_j3w9t_collab.ccu013_covid_events_paper_cohort` 1 row per patient, specified in cell 4 below
# MAGIC 
...
# Input tables
trajectory_table = "dars_nic_391419_j3w9t_collab.ccu013_covid_trajectory_paper_cohort"
# Output table
# NB no dars_.. prefix
