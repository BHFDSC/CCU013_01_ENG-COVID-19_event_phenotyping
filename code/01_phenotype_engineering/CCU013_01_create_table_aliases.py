...
# MAGIC * `.ccu003_direfcts_dataprep_1_sgss_frzon28may_mm_210528`  
# MAGIC * `.ccu003_direfcts_dataprep_1_gdppr_frzon28may_mm_210528`
# MAGIC * `.ccu003_direfcts_dataprep_1_deaths_frzon28may_mm_210528`
# MAGIC * `.ccu003_direfcts_dataprep_1_sus_frzon28may_mm_210528`
# MAGIC * `.ccu003_direfcts_dataprep_1_pillar2_frzon28may_mm_210528` **Not currently used**
# MAGIC * `.ccu003_direfcts_dataprep_1_apc_all_frzon28may_mm_210528`
# MAGIC * `.ccu003_direfcts_dataprep_1_cc_all_frzon28may_mm_210528`
# MAGIC * `.ccu003_direfcts_dataprep_1_op_all_frzon28may_mm_210528 ` **Not currently used**
# MAGIC * `.ccu003_direfcts_dataprep_1_chess_frzon28may_mm_210528`
# MAGIC 
# MAGIC **Data output**
...
sgss = spark.sql('''SELECT person_id_deid, REPORTING_LAB_ID, specimen_date FROM 
                    .ccu003_direfcts_dataprep_1_sgss_frzon28may_mm_210528''')
...
# GDPPR
gdppr = spark.sql('''SELECT NHS_NUMBER_DEID, DATE, LSOA, code FROM .ccu003_direfcts_dataprep_1_gdppr_frzon28may_mm_210528''')
...
# MAGIC %sql
# MAGIC SELECT max(date) FROM .ccu013_tmp_gdppr

# COMMAND ----------

# MAGIC %sql -- create_table makes all tables as deltatables by default optimize
# MAGIC OPTIMIZE .ccu013_tmp_gdppr
...
# MAGIC --    FROM .ccu003_direfcts_dataprep_1_deaths_frzon28may_mm_210528
# MAGIC --  ) cte
...
# Deaths
death = spark.sql('''SELECT * FROM .ccu003_direfcts_dataprep_1_deaths_frzon28may_mm_210528''')
...
# MAGIC %sql
# MAGIC SELECT max(death_date) FROM .ccu013_tmp_deaths

# COMMAND ----------

# MAGIC %sql -- create_table makes all tables as deltatables by default optimize
# MAGIC OPTIMIZE .ccu013_tmp_deaths
...
#op = spark.sql('''SELECT tab1.* FROM .ccu003_direfcts_dataprep_1_op_all_frzon28may_mm_210528 as tab1
#                  INNER JOIN .ccu013_total_population ON tab1.PERSON_ID_DEID = ccu013_total_population.person_id_deid''')
...
apc = spark.sql('''SELECT PERSON_ID_DEID, EPISTART, DIAG_4_CONCAT, OPERTN_4_CONCAT, DISMETH, DISDEST, DISDATE, SUSRECID FROM
                    .ccu003_direfcts_dataprep_1_apc_all_frzon28may_mm_210528
...
# MAGIC %sql
# MAGIC SELECT max(date) FROM .ccu013_tmp_apc

# COMMAND ----------

# MAGIC %sql
# MAGIC OPTIMIZE .ccu013_tmp_apc
...
# HES CC
cc = spark.sql('''SELECT * FROM .ccu003_direfcts_dataprep_1_cc_all_frzon28may_mm_210528''')
...
# MAGIC %sql
# MAGIC SELECT max(date) FROM .ccu013_tmp_cc

# COMMAND ----------

# MAGIC %sql -- create_table makes all tables as deltatables by default optimize
# MAGIC OPTIMIZE .ccu013_tmp_cc
...
# FROM .ccu003_direfcts_dataprep_1_pillar2_frzon28may_mm_210528
...
# %sql
# SELECT max(date) FROM .ccu013_tmp_pillar2

# COMMAND ----------

# %sql -- create_table makes all tables as deltatables by default optimize
# OPTIMIZE .ccu013_tmp_pillar2
...
FROM .ccu003_direfcts_dataprep_1_chess_frzon28may_mm_210528
""")
...
# MAGIC %sql
# MAGIC SELECT max(date) FROM .ccu013_tmp_chess

# COMMAND ----------

# MAGIC %sql -- create_table makes all tables as deltatables by default optimize
# MAGIC OPTIMIZE .ccu013_tmp_chess
...
FROM .ccu003_direfcts_dataprep_1_sus_frzon28may_mm_210528
""")
...
# MAGIC %sql
# MAGIC SELECT max(END_DATE_HOSPITAL_PROVIDER_SPELL) FROM .ccu013_tmp_sus

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT max(date) FROM .ccu013_tmp_sus

# COMMAND ----------

# MAGIC %sql -- create_table makes all tables as deltatables by default optimize
# MAGIC -- ! Takes ~ 24 mins
# MAGIC OPTIMIZE .ccu013_tmp_sus
