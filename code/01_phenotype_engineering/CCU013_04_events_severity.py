...
# MAGIC  
# MAGIC **Data input**  
# MAGIC * `.ccu013_covid_trajectory` Specified in cell 4 below  
# MAGIC 
# MAGIC **Data output**  
# MAGIC * `.ccu013_covid_events` 1 row per patient
# MAGIC 
...
# Input tables
trajectory_table = ".ccu013_covid_trajectory"
# Output table
# NB no dars_.. prefix
...
# MAGIC FROM
# MAGIC   .ccu013_covid_events

# COMMAND ----------

# Get schema
display(spark.sql(f"SHOW COLUMNS FROM .{output_table}"))
