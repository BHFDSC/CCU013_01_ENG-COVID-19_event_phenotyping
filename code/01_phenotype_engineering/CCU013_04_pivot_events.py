...
# MAGIC   
# MAGIC   
# MAGIC 1. Extracts distinct COVID events, per individual, from `.ccu013_covid_trajectory`
# MAGIC     1. Produces binary outcome matrix
# MAGIC 2. Extract from `.ccu013_covid_trajectory`:
...
# MAGIC %sql
# MAGIC OPTIMIZE .ccu013_covid_events ZORDER BY person_id_deid
