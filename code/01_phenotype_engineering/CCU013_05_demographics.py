...
# COVID-19 events
events_table = ".ccu013_covid_events"
# Demographics table
...
display(spark.sql(f"SELECT COUNT(*), COUNT(DISTINCT person_id_deid) FROM .{output_table}"))

# COMMAND ----------

display(spark.sql(f"SELECT * FROM .{output_table} LIMIT 10"))
