...
# MAGIC  
# MAGIC **Data input**   
# MAGIC * **Key demographics: `.curr302_patient_skinny_record` **
# MAGIC * LSOA, comorbidity code search: `.gdppr__archive`  
...
# MAGIC   
# MAGIC **Data output**  
# MAGIC * `.ccu013_master_demographics` 1 row per patient
# MAGIC 
...
# MAGIC %sql
# MAGIC SELECT distinct ProductionDate FROM .curr302_patient_skinny_record
...
# Table names
skinny_record = ".curr302_patient_skinny_record_archive"
gdppr = ".gdppr__archive"
...
spark.sql(f"OPTIMIZE .{output} ZORDER BY person_id_deid")

# COMMAND ----------

display(
  spark.sql(f"""
  SELECT COUNT(*), COUNT(DISTINCT person_id_deid) FROM .{output}
  """)
)
...
# MAGIC   * This was derived from `.curr302_patient_skinny_record WHERE ProductionDate = '2021-08-18 14:47:00.887883'`
# MAGIC     * SELECT COUNT(distinct person_id_deid) FROM .ccu013_master_demographics WHERE ethnicity='Unknown' = 25,935,198
# MAGIC   * Using `.curr302_patient_skinny_record_archive WHERE ProductionDate = "2021-07-29 13:39:04.161949"`  
# MAGIC     * = 21,070,900
...
# MAGIC %sql
# MAGIC SELECT COUNT(distinct person_id_deid) FROM .ccu013_master_demographics
# MAGIC WHERE ethnicity='Unknown'

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT COUNT(*) FROM .ccu013_master_demographics
