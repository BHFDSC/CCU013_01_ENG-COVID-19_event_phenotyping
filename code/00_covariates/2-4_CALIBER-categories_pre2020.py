...
skinny_table = ".ccu013_caliber_skinny"
comorbidities_table = ".ccu013_caliber_comorbidities_pre2020"
...
dictionary = spark.sql(f"SELECT phenotype, category FROM .{category_dictionary_table}").toPandas()
