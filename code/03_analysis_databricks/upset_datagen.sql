...
SELECT * FROM .ccu013_covid_trajectory_paper_cohort LIMIT 5

-- COMMAND ----------

 SELECT * FROM .ccu013_covid_events_paper_cohort LIMIT 5

-- COMMAND ----------

 SELECT distinct covid_phenotype FROM .ccu013_covid_trajectory_paper_cohort
...
-- COMMAND ----------
 ...
 SELECT * FROM .ccu013_covid_events_demographics_paper_cohort LIMIT 5
...
SELECT * FROM .ccu013_01_paper_upset
